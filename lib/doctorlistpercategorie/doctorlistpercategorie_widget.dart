...
class DoctorlistpercategorieWidget extends StatefulWidget {
  const DoctorlistpercategorieWidget({
    Key key,
    this.categegories,
  }) : super(key: key);

  final String categegories;

  @override
  _DoctorlistpercategorieWidgetState createState() =>
      _DoctorlistpercategorieWidgetState();
}

class _DoctorlistpercategorieWidgetState
    extends State<DoctorlistpercategorieWidget> {
                    ...
                    child: StreamBuilder<List<UsersRecord>>(
                      stream: queryUsersRecord(
                        queryBuilder: (usersRecord) => usersRecord
                            ...
                            .where('doctor_category',
                                isEqualTo: widget.categegories),
                      ),
