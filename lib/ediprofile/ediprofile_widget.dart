...
class EdiprofileWidget extends StatefulWidget {
  const EdiprofileWidget({Key key}) : super(key: key);

  @override
  _EdiprofileWidgetState createState() => _EdiprofileWidgetState();
}

class _EdiprofileWidgetState extends State<EdiprofileWidget> {
