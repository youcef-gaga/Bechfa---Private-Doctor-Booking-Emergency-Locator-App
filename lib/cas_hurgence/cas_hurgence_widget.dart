...
class CasHurgenceWidget extends StatefulWidget {
  const CasHurgenceWidget({Key key}) : super(key: key);

  @override
  _CasHurgenceWidgetState createState() => _CasHurgenceWidgetState();
}

class _CasHurgenceWidgetState extends State<CasHurgenceWidget> {
